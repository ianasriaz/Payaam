...
[![Live on AWS](https://img.shields.io/badge/Hosted-AWS%20EC2%20(t3.micro)-success.svg)](http://54.152.197.5:8000/api/health)
...
- **Health Check API**: [http://54.152.197.5:8000/api/health](http://54.152.197.5:8000/api/health)
- **Background Daemons**:
