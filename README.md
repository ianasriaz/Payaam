...
[![Live on AWS](https://img.shields.io/badge/Hosted-AWS%20EC2%20(t3.micro)-success.svg)](http://54.227.185.249:8000/api/health)
...
- **Public IP**: `54.227.185.249`
- **Live Agent Email**: `agent@anasriaz.com` *(Judges & users can send an email directly to experience the Zero-UI flow!)*
- **Health Check API**: [http://54.227.185.249:8000/api/health](http://54.227.185.249:8000/api/health)
- **Background Daemons**:
