...
[![Live on AWS](https://img.shields.io/badge/Hosted-AWS%20EC2%20(t3.micro)-success.svg)](http://54.234.127.221:8000/api/health)
...
- **Public IP**: `54.234.127.221`
- **Agent Email Gateway**: `agent@anasriaz.com` (Purelymail 24/7 Daemon)
- **Health Check API**: [http://54.234.127.221:8000/api/health](http://54.234.127.221:8000/api/health)
- **Background Daemons**:
